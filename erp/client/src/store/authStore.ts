...
interface AuthState {
  user: { uid: string; email: string; role: string; deptId?: number; name?: string; avatar?: string; subDepartment?: string; phone?: string; dateOfBirth?: string; bio?: string; address?: string } | null;
  token: string | null;
