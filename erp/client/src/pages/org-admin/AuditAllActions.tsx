    ...
    <div className="p-8 max-w-7xl mx-auto space-y-6">
                  ...
                  >
                    ...
                    <td className="px-8 py-5 text-right">
                      <div className={`inline-flex items-center px-3 py-1.5 rounded-xl text-[10px] font-bold transition-all ${
                        ...
                        {expandedRow === audit.id ? <FileJson className="w-3.5 h-3.5 mr-1.5" /> : <Code2 className="w-3.5 h-3.5 mr-1.5" />}
                        {expandedRow === audit.id ? 'Hide Diff' : 'View Diff'}
                      </div>
                    </td>
                  </tr>
                      ...
                      <td colSpan={5} className="px-8 py-8 border-b border-slate-200 shadow-inner">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="bg-white border border-slate-200 rounded-2xl p-6 font-mono text-[11px] overflow-x-auto shadow-sm max-h-[400px]">
                              {audit.before ? (
                                <pre className="text-slate-600 leading-relaxed font-bold">{JSON.stringify(audit.before, null, 2)}</pre>
                              ) : (
                                <div className="text-slate-300 font-bold py-10 text-center italic">NULL / NEW ENTITY</div>
                              )}
                            </div>
                          </div>
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 font-mono text-[11px] overflow-x-auto shadow-xl max-h-[400px]">
                              {audit.after ? (
                                <pre className="text-blue-300 leading-relaxed font-bold">{JSON.stringify(audit.after, null, 2)}</pre>
                              ) : (
                                <div className="text-rose-400 font-bold py-10 text-center italic">NULL / DELETED ENTITY</div>
                              )}
                            </div>
                          </div>
                        </div>
      ...
      <div className="bg-blue-600 rounded-3xl p-8 text-white relative overflow-hidden group shadow-2xl">
        ...
        <div className="max-w-2xl relative z-10">
          <h2 className="text-2xl font-bold mb-3 tracking-tight font-display">Gap-5 Compliance Monitoring</h2>
