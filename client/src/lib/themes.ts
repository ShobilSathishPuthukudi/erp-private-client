...
export const THEME_PRESETS: ThemePreset[] = [
  ...
  },
  {
    ...
    vars: {
      ...
      '--card-border': '#dbe4ff',
      '--card-accent': '#4f46e5',
      '--card-shadow': '0 4px 12px -2px rgb(79 70 229 / 0.08)',
    },
  },
  {
    id: 'emerald',
    ...
    vars: {
      ...
      '--card-border': '#c8f2dd',
      '--card-accent': '#059669',
      '--card-shadow': '0 4px 12px -2px rgb(5 150 105 / 0.08)',
    },
  },
  {
    id: 'amber',
    ...
    vars: {
      ...
      '--card-border': '#fde8a8',
      '--card-accent': '#d97706',
      '--card-shadow': '0 4px 12px -2px rgb(217 119 6 / 0.08)',
    },
  },
  {
    id: 'rose',
    ...
    vars: {
      ...
      '--card-border': '#fedee2',
      '--card-accent': '#e11d48',
      '--card-shadow': '0 4px 12px -2px rgb(225 29 72 / 0.08)',
    },
  },
  {
    id: 'midnight',
    ...
    vars: {
      ...
      '--card-accent': '#818cf8',
      '--card-shadow': '0 6px 20px -4px rgb(0 0 0 / 0.5)',
    },
  },
];
