...
export default function TargetManager() {
  ...
  return (
    <div className="p-2 space-y-6">
      <PageHeader 
        title="Sales Incentives Approval Flow"
        description="Finance defines incentive plans, Operations verifies and bulk-assigns them, live employee progress is tracked during the cycle, and Finance then approves or denies each completed assignment with payout and next-cycle controls."
        icon={Target}
        action={
          <button
            onClick={() => setIsModalOpen(true)}
            className="inline-flex items-center justify-center gap-2 rounded-2xl bg-slate-900 px-6 py-3 font-bold text-white transition hover:bg-slate-800 shadow-lg shadow-slate-900/20 whitespace-nowrap"
          >
