...
export default function AccreditationInterest() {
    ...
    return (
    <div className="p-2 space-y-10 max-w-[1600px] mx-auto min-h-screen">
            <PageHeader 
                ...
                action={
                    <button 
                        ...
                        className="flex items-center gap-2 bg-slate-900 text-white px-6 py-3 rounded-2xl font-black text-[11px] tracking-widest shadow-2xl shadow-slate-900/20 hover:scale-105 active:scale-95 transition-all"
                    >
            ...
            {isLoading ? (
                            ...
                            >
                                <div className="flex justify-between items-start mb-8">
                                    ...
                                    <div className={`flex flex-col items-end gap-2`}>
                                        <span className={`px-5 py-2 text-[10px] font-black tracking-widest rounded-full border shadow-sm ${style.bg}`}>
                                            {style.label}
                                        </span>
                                        <span className="text-[9px] font-bold text-slate-400 tracking-widest flex items-center gap-1.5">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h3 className="font-black text-slate-900 text-2xl leading-tight group-hover:text-slate-900 transition-colors tracking-tighter mb-1.5">{request.courseName}</h3>
                                        <div className="flex items-center gap-2">
                                            <span className="px-2.5 py-1 bg-slate-100 rounded-lg text-[9px] font-black text-slate-500 tracking-widest">{request.type.toLowerCase()} unit</span>
                                            <span className="h-1 w-1 rounded-full bg-slate-300" />
                                            <span className="text-[10px] font-bold text-slate-400 tracking-tight">{request.universityName}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="pt-6 border-t border-slate-100 flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[11px] font-black tracking-widest text-slate-700">{request.status.replace('_', ' ')}</span>
                                        </div>
                ...
                <div className="bg-white border-2 border-dashed border-slate-200 rounded-[4rem] p-24 text-center space-y-8 shadow-inner shadow-slate-50">
                    ...
                    <div className="space-y-3">
                        <h3 className="text-3xl font-black text-slate-900 tracking-tighter">No request history</h3>
                    ...
                    <button 
                        onClick={() => setIsModalOpen(true)}
                        className="px-10 py-4 bg-slate-900 text-white rounded-[1.5rem] font-black text-[11px] tracking-widest shadow-2xl shadow-slate-900/30 hover:scale-105 active:scale-95 transition-all"
                    >
                        Initiate deployment
                    </button>
                </div>
            ...
            >
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 p-4">
                    <div className="bg-slate-900 text-white p-8 rounded-[2rem] relative overflow-hidden shadow-2xl shadow-slate-900/20 mb-8">
                        ...
                        <h2 className="text-2xl font-black tracking-tighter mb-1">New program request</h2>
                        <p className="text-slate-400 text-xs font-bold tracking-widest">Request institutional tie-ups for existing frameworks.</p>
                    </div>

                    <div className="space-y-8">
                        <div className="space-y-3">
                            <label className="text-[11px] font-black text-slate-400 tracking-widest flex items-center gap-3">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="w-full px-6 py-5 bg-indigo-50 border border-indigo-100 rounded-3xl flex items-center justify-between">
                                <span className="font-black text-indigo-900 tracking-tight">
                                    {entities.universities[0]?.name || 'Fetching assignment...'}
                                </span>
                                <span className="bg-indigo-600 text-white text-[9px] font-black px-3 py-1 rounded-full tracking-widest">Fixed partner</span>
                    ...
                    <div className="pt-8 border-t border-slate-100">
                        <button 
                            ...
                            className="w-full bg-slate-900 text-white py-5 rounded-[1.5rem] font-black text-xs tracking-widest hover:bg-slate-800 disabled:opacity-50 transition-all flex items-center justify-center gap-3 shadow-2xl shadow-slate-900/30"
                        >
                        ...
                        <div className="space-y-10 p-4">
                            <div className="flex items-center gap-6">
                                ...
                                <div className="flex-1">
                                    <h2 className="text-3xl font-black text-slate-900 tracking-tighter leading-tight mb-2">{selectedRequest.courseName}</h2>
                                    <div className="flex flex-wrap gap-2">
                                        <span className={`px-4 py-1.5 rounded-full border text-[10px] font-black tracking-widest flex items-center gap-2 ${style.bg}`}>
                                            <StatusIcon className="w-3 h-3" />
                                            {style.label}
                                        </span>
                                        <span className="px-4 py-1.5 bg-slate-100 text-slate-500 border border-slate-200 rounded-full text-[10px] font-black tracking-widest">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="p-8 bg-slate-50 border border-slate-100 rounded-[2.5rem] space-y-4">
                                    <div className="flex items-center gap-3 text-slate-400">
                                        ...
                                        <span className="text-[10px] font-black tracking-widest">Target institution</span>
                                    </div>
                                ...
                                <div className="p-8 bg-slate-50 border border-slate-100 rounded-[2.5rem] space-y-4">
                                    <div className="flex items-center gap-3 text-slate-400">
                                        ...
                                        <span className="text-[10px] font-black tracking-widest">Deployment unit</span>
                                    </div>
                                    <p className="text-lg font-black text-slate-900 tracking-tight leading-snug">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h3 className="text-xs font-black text-slate-900 tracking-widest">Governance feedback</h3>
                                </div>
                                <div className="p-8 bg-white border border-slate-200 rounded-[3rem] shadow-inner shadow-slate-50">
                                    {selectedRequest.remarks ? (
                                        ...
                                        <div className="text-center py-6">
                                            <p className="text-slate-400 text-sm font-bold tracking-tight italic">Awaiting administrative feedback packet...</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="pt-10 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-[9px] font-black text-slate-400 tracking-widest mb-0.5">Logging timestamp</p>
                                ...
                                <button 
                                    ...
                                    className="px-10 py-4 bg-slate-900 text-white rounded-[1.5rem] font-black text-[11px] tracking-widest shadow-2xl shadow-slate-900/20 hover:scale-105 active:scale-95 transition-all w-full md:w-auto"
                                >
                                    Dismiss examination
                                </button>
                            </div>
