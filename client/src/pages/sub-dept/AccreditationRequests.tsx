...
import { CheckCircle, Info, ShieldCheck, Link as LinkIcon, Eye } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        rows={3}
                        placeholder={isReadOnly ? "No additional remarks recorded." : "Accreditation criteria verified..."}
                    />
                </div>
            </div>
            ...
            <div className="pt-6 border-t border-slate-100 flex justify-end gap-3 uppercase">
                {!isReadOnly ? (
                    ...
                    <button 
                        onClick={() => setIsModalOpen(false)}
                        className="px-8 py-2 bg-slate-100 text-slate-600 rounded-xl font-bold hover:bg-slate-200 transition-all uppercase tracking-widest text-xs"
                    >
                        Close Registry
                    </button>
                )}
