    ...
    <div className="p-2 space-y-6 flex flex-col">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white px-6 py-5 rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/40 gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black text-slate-900 tracking-tight leading-tight mb-0.5">HR Broadcasts</h1>
            <p className="text-slate-500 font-medium text-sm">Review all universal broadcasts distributed by Human Resources to the entire institutional workforce.</p>
          </div>
        </div>
      </div>
